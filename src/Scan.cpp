...
int Scan::handleGapEvent(ble_gap_event *event, void *arg) {
  ...
  case BLE_GAP_EVENT_DISC: {
    ...
    AdvertisedDevice *advertisedDevice = nullptr;
 ...
 */
void Scan::setActiveScan(bool active) {
 ...
 */
void Scan::setDuplicateFilter(bool enabled) {
 ...
 */
void Scan::setLimitedOnly(bool enabled) {
 ...
 */
void Scan::setFilterPolicy(uint8_t filter) {
 ...
 */
void Scan::setMaxResults(uint8_t maxResults) {
 ...
 */
void Scan::setInterval(uint16_t intervalMSecs) {
 ...
 */
void Scan::setWindow(uint16_t windowMSecs) {
 ...
 */
bool Scan::start(uint32_t duration, bool is_continue) {
 ...
 */
void Scan::erase(const Address &address) {
