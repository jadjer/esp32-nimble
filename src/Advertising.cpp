...
void Advertising::reset() {
  ...
  m_advData.tx_pwr_lvl = Device::getPower();
 ...
 */
void Advertising::addServiceUUID(const UUID &serviceUUID) {
 ...
 */
void Advertising::addServiceUUID(const char *serviceUUID) {
  addServiceUUID(UUID(serviceUUID));
  m_advDataSet = false;
}// addServiceUUID
 ...
 * @param [in] serviceUUID The UUID of the service to expose.
 */
void Advertising::removeServiceUUID(const UUID &serviceUUID) {
 ...
 */
void Advertising::setAppearance(uint16_t appearance) {
 ...
 */
void Advertising::setName(const std::string &name) {
 ...
 */
void Advertising::setManufacturerData(const std::string &data) {
 ...
 * @param [in] data The data to advertise.
 */
void Advertising::setManufacturerData(const std::vector<uint8_t> &data) {
  m_mfgData = data;
  m_advData.mfg_data = &m_mfgData[0];
  m_advData.mfg_data_len = m_mfgData.size();
  m_advDataSet = false;
 ...
 */
void Advertising::setURI(const std::string &uri) {
 ...
 */
void Advertising::setServiceData(const UUID &uuid, const std::string &data) {
  switch (uuid.bitSize()) {
  case 16: {
 ...
 */
void Advertising::setAdvertisementType(uint8_t adv_type) {
 ...
 */
void Advertising::setMinInterval(uint16_t mininterval) {
 ...
 */
void Advertising::setMaxInterval(uint16_t maxinterval) {
 ...
 */
void Advertising::setMinPreferred(uint16_t mininterval) {
 ...
 */
void Advertising::setMaxPreferred(uint16_t maxinterval) {
  // invalid paramters, set the slave interval to null
 ...
 */
void Advertising::setScanResponse(bool set) {
  m_scanResp = set;
  m_advDataSet = false;
}// setScanResponse
 ...
 */
void Advertising::setScanFilter(bool scanRequestWhitelistOnly, bool connectWhitelistOnly) {
...
void Advertising::setAdvertisementData(AdvertisementData &advertisementData) {
 ...
 */
void Advertising::setScanResponseData(AdvertisementData &advertisementData) {
 ...
 */
bool Advertising::start(uint32_t duration, void (*advCompleteCB)(Advertising *pAdv), Address *dirAddr) {
...
#if defined(CONFIG_BT_NIMBLE_ROLE_PERIPHERAL)
  Server *pServer = Device::getServer();
  if (pServer != nullptr) {
...
#if defined(CONFIG_BT_NIMBLE_ROLE_PERIPHERAL)
  rc = ble_gap_adv_start(Device::m_own_addr_type,
                         (dirAddr != nullptr) ? &peerAddr : NULL,
                         duration,
                         &m_advParams,
                         (pServer != nullptr) ? Server::handleGapEvent : Advertising::handleGapEvent,
                         (void *) this);
#else
 ...
 */
void Advertising::advCompleteCB() {
 ...
 */
/*STATIC*/
int Advertising::handleGapEvent(struct ble_gap_event *event, void *arg) {
  Advertising *pAdv = (Advertising *) arg;
  ...
  if (event->type == BLE_GAP_EVENT_ADV_COMPLETE) {
    ...
    case BLE_HS_ENOTSYNCED:
      ...
      Device::onReset(event->adv_complete.reason);
      return 0;
    default:
      break;
    }
 ...
 */
void AdvertisementData::addData(const std::string &data) {
 ...
 */
void AdvertisementData::addData(char *data, size_t length) {
 ...
 * https://www.bluetooth.com/specifications/gatt/viewer?attributeXmlFile=org.bluetooth.characteristic.gap.appearance.xml
 */
void AdvertisementData::setAppearance(uint16_t appearance) {
  char cdata[2];
  cdata[0] = 3;
 ...
 */
void AdvertisementData::setFlags(uint8_t flag) {
  char cdata[3];
  cdata[0] = 2;
 ...
 */
void AdvertisementData::setManufacturerData(const std::string &data) {
  char cdata[2];
 ...
 * @param [in] data The manufacturer data to advertise.
 */
void AdvertisementData::setManufacturerData(const std::vector<uint8_t> &data) {
  char cdata[2];
  cdata[0] = data.size() + 1;
  cdata[1] = BLE_HS_ADV_TYPE_MFG_DATA;// 0xff
 ...
 * @param [in] uri The uri to advertise.
 */
void AdvertisementData::setURI(const std::string &uri) {
  char cdata[2];
 ...
 * @param [in] name The name to advertise.
 */
void AdvertisementData::setName(const std::string &name) {
  char cdata[2];
 ...
 */
void AdvertisementData::setCompleteServices(const UUID &uuid) {
 ...
 */
void AdvertisementData::setCompleteServices16(const std::vector<UUID> &v_uuid) {
 ...
 */
void AdvertisementData::setCompleteServices32(const std::vector<UUID> &v_uuid) {
 ...
 * @param [in] uuid The service to advertise.
 */
void AdvertisementData::setPartialServices(const UUID &uuid) {
 ...
 * @param [in] v_uuid A vector of 16 bit UUID's to advertise.
 */
void AdvertisementData::setPartialServices16(const std::vector<UUID> &v_uuid) {
 ...
 * @param [in] v_uuid A vector of 32 bit UUID's to advertise.
 */
void AdvertisementData::setPartialServices32(const std::vector<UUID> &v_uuid) {
 ...
 */
void AdvertisementData::setServices(const bool complete, const uint8_t size,
 ...
 */
void AdvertisementData::setServiceData(const UUID &uuid, const std::string &data) {
  char cdata[2];
  switch (uuid.bitSize()) {
  case 16: {
 ...
 */
void AdvertisementData::setShortName(const std::string &name) {
  char cdata[2];
  cdata[0] = name.length() + 1;
 ...
 */
void AdvertisementData::setPreferredParams(uint16_t min, uint16_t max) {
  char cdata[6];
 ...
 */
std::string AdvertisementData::getPayload() {
  return m_payload;
}// getPayload
